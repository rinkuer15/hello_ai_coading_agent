...
The Codex CLI picks up all of these automatically because Devox inherits the full process environment when spawning the CLI. No Devox configuration needed — just set up the Codex CLI config once.
...
- id: github-analysis
  ...
  mcp: .devox/mcp/github.json          # Path relative to repo root
