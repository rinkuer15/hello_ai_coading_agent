...
- [[_COMMUNITY_Governance Docs Overview|Governance Docs Overview]]
- [[_COMMUNITY_Package Manifest & Scripts|Package Manifest & Scripts]]
- [[_COMMUNITY_ES5 Oracle Architecture|ES5 Oracle Architecture]]
- [[_COMMUNITY_ES5 Gate & Test Assertions|ES5 Gate & Test Assertions]]
- [[_COMMUNITY_Guardrails Authority Rules|Guardrails Authority Rules]]
- [[_COMMUNITY_Compliance Gates & Traps|Compliance Gates & Traps]]
- [[_COMMUNITY_On-Demand Context Modules|On-Demand Context Modules]]
- [[_COMMUNITY_Mission Scope Triage|Mission Scope Triage]]
...
### Community 0 - "Governance Docs Overview"
Cohesion: 0.22
...
### Community 3 - "ES5 Gate & Test Assertions"
Cohesion: 0.29
...
### Community 4 - "Guardrails Authority Rules"
Cohesion: 0.36
...
- **Why does `package.json` connect `Package Manifest & Scripts` to `Governance Docs Overview`?**
  _High betweenness centrality (0.206) - this node is a cross-community bridge._
- **Why does `MISSION.md` connect `Governance Docs Overview` to `ES5 Oracle Architecture`, `Guardrails Authority Rules`, `Compliance Gates & Traps`?**
